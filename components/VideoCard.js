  ...
  return (
    <article className="relative flex flex-col-reverse items-center bg-gray-100 p-8">
      ...
      <div className="relative mb-8 w-full">
        ...
        {playButton && (
          <div className="absolute top-1/2 left-1/2 flex h-28 w-28 -translate-x-1/2 -translate-y-1/2 transform flex-col items-center justify-center rounded-full bg-io_orange-500 align-middle text-white shadow-lg">
            <svg
