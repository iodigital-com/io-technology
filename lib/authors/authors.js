...
export async function getAllAuthors() {
  try {
    ...
    // Ensure allAuthorsArray is an array
    if (!Array.isArray(allAuthorsArray)) {
      console.warn('getAllFilesFrontMatter returned non-array for authors:', allAuthorsArray)
      return []
    }
...
export async function getWorkshopsByAuthor(author) {
