...
describe('kebabCase', () => {
  ...
  it('should handle null input when cast to string', () => {
    expect(() => kebabCase(String(null))).not.toThrow()
    // Depending on implementation, might return empty string or throw
  })

  it('should handle undefined input when cast to string', () => {
    expect(() => kebabCase(String(undefined))).not.toThrow()
  })

  it('should handle numbers when cast to string', () => {
    expect(() => kebabCase(String(123))).not.toThrow()
  })
