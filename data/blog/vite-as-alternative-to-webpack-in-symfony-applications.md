...
<div className="p-4 bg-io_electric_blue-100 font-serif">All examples used in this blogpost will be using [Vue](https://vuejs.org/), but Vite can be used with a variety of frameworks.</div>
...
<div className="p-4 bg-io_electric_blue-100 text-io_electric_blue-800">This example uses <b>.ts</b> files. Just change this to <b>.js</b> if you don't use Typescript</div>
