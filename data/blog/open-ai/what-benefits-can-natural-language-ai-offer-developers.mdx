...
summary: 'In this first part we'll look at how natural language AI can offer developers a lot of benefits, from helping them write code to writing this blog post. Here, we will introduce you to two of the most popular natural language AI tools, OpenAI GPT-3 and GitHub Copilot, and discuss some of the best use cases for each.'
authors: ['vince-liem', 'openai-gpt3']
theme: 'rouge'
serie: 'open-ai'
---

<div className="bg-io_rouge-100 p-4">
