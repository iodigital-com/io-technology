...
summary: 'Defining a good structure for your theme, components, and files is key to maintainable code and UX for multiple brands. These guidelines will help you out if you're coding multiple applications within one shared codebase.'
